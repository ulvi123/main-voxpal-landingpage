  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Subscribe to receive upcoming product updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        We release regular product updates based on your feedback and how you see the app from your point of view.
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          We are all busy with delivering the best product to you,kindly ask to send only urgent emails.
        </p>
      </div>
